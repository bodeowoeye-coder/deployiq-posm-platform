        ...
        mappable.forEach((item) => {
          ...
          const popup =
            ...
            <div style="min-width:180px">
              ...
              <span>${escapeHtml(item.installation_date || displaySubmissionDate(item.submitted_at))}</span>
            </div>
          `
              : `
            <div style="min-width:180px">
              ...
              <span>${escapeHtml(item.status)} | ${escapeHtml(item.installation_date || displaySubmissionDate(item.submitted_at))}</span>
            </div>
          `;
