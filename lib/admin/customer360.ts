  ...
  return {
    ...
    commercial: {
      ...
      shadowPlanning: shadowPlanning ? {
        ...
        provider: text(shadowPlanning.provider) || null,
        model: text(shadowPlanning.model) || null,
        providerVersion: text(shadowPlanning.providerVersion) || null,
        promptSchemaVersion: text(shadowPlanning.promptSchemaVersion) || null,
        fallbackUsed: Boolean(shadowPlanning.fallbackUsed),
        providerFailureCode: text(shadowPlanning.providerFailureCode) || null,
        generationDurationMs: Number(shadowPlanning.generationDurationMs ?? 0) || null,
