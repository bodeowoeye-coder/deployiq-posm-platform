    ...
    if (shouldRunProvisioningShadow(eligibility.productKey)) {
      try {
        ...
        await recordEvent(job.id, "validating", "provisioning_shadow_plan_generated", "DeployIQ AI Shadow Mode plan generated and validated.", {
          ...
          provider: shadowPlanning.provider,
          model: shadowPlanning.model,
          promptSchemaVersion: shadowPlanning.promptSchemaVersion,
          generationDurationMs: shadowPlanning.generationDurationMs,
          fallbackUsed: shadowPlanning.fallbackUsed,
          providerFailureCode: shadowPlanning.providerFailureCode ?? null,
